...
<head>
    ...
    <script>
        ...
        script.defer = true;
        script.src = '<?php echo esc_url(get_template_directory_uri() . '/assets/js/script.js'); ?>';
...
<body <?php body_class(); ?> data-base="">
    <?php wp_body_open(); ?>
    <header id="site-header" class="navbar navbar-expand-lg sticky-top p-0" data-astro-cid-nen7h5rs>
        <div class="container bar d-flex justify-content-between align-items-center" data-astro-cid-nen7h5rs>
            <!-- Logo -->
            <a class="navbar-brand home-link d-inline-flex" href="/" aria-label="MC²+ home" data-astro-cid-nen7h5rs>
                <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/images/Mc2&#32;Logo.png'); ?>" width="9000" height="4861" alt="" aria-hidden="true" class="logo logo--header" data-astro-cid-f7espo7c>
            </a>
            <!-- Mobile Menu Button -->
            <button id="menu-button" class="navbar-toggler border-0 p-2" type="button" aria-expanded="false" aria-controls="site-nav" aria-label="Toggle navigation" data-astro-cid-nen7h5rs>
                <span class="sr-only" data-astro-cid-nen7h5rs>Menu</span>
                <span class="burger" aria-hidden="true" data-astro-cid-nen7h5rs></span>
            </button>
            <!-- Navigation -->
            <nav id="site-nav" class="collapse navbar-collapse show-lg" aria-label="Main" data-astro-cid-nen7h5rs>
                <ul class="navbar-nav nav-list d-flex list-unstyled m-0 p-0" data-astro-cid-nen7h5rs>
                    ...
                    <li class="nav-item dropdown has-submenu" data-astro-cid-nen7h5rs>
                        <button type="button" class="nav-link submenu-trigger dropdown-toggle border-0 bg-transparent" aria-expanded="false" aria-controls="submenu-6" data-astro-cid-nen7h5rs>
                            Engagements
                            <svg class="submenu-chevron" width="10" height="6" viewBox="0 0 10 6" fill="none" aria-hidden="true" data-astro-cid-nen7h5rs>
                                <path d="M1 1L5 5L9 1" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-astro-cid-nen7h5rs></path>
                            </svg>
                        </button>
                    ...
                    <!-- Apply -->
                    <li class="nav-item" data-astro-cid-nen7h5rs>
                        <a class="apply-link" href="https://app.mc2plus.in/ext/form/24027/1/apply" target="_blank" rel="noopener noreferrer" data-astro-cid-nen7h5rs>Apply</a>
                    </li>
                </ul>
            </nav>
        </div>
