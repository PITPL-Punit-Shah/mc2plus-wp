...
get_header(); ?>
    ...
    <section class="hero position-relative overflow-hidden" data-astro-cid-p5233ohg>
      ...
      <div class="hero-inner reveal text-center mx-auto position-relative" data-astro-cid-p5233ohg>
        <p class="eyebrow" data-astro-cid-p5233ohg>PROCUREMENTS</p>
        <div class="underline mx-auto" aria-hidden="true" data-astro-cid-p5233ohg></div>
        <p class="lede reveal-rise reveal-rise--after-3-lines" data-astro-cid-p5233ohg>Open tenders, RFPs and vendor
          empanelment opportunities at MC²+.</p>
        <p class="lede reveal-rise reveal-rise--after-3-lines" data-astro-cid-p5233ohg>MC&sup2;+ periodically invites
          bids from qualified vendors, service providers and agencies to support our infrastructure, programme
          delivery and operations. All tenders are published here along with the relevant documents and submission
          process. MC&sup2;+ reserves the right to accept or reject any or all bids without assigning reasons.</p>
      ...
      <div class="container" data-astro-cid-ohdyr4rw>
        <div class="container heading reveal text-center" data-astro-cid-ohdyr4rw>
          <div class="section-heading" data-astro-cid-ypavld2q>
            <p class="eyebrow" data-astro-cid-ypavld2q>OPEN TENDERS</p>
            <h2 data-astro-cid-ypavld2q>
              <span class="reveal-line" data-astro-cid-ohdyr4rw>
                <span class="reveal-line-box" data-astro-cid-ohdyr4rw>
                  <span class="reveal-line-text" data-astro-cid-ohdyr4rw>Current tenders</span>
          ...
          <p class="intro" data-astro-cid-ohdyr4rw>Click a tender to submit a bid or download the full RFP document.</p>
        </div>

        <div class="tender-list" data-astro-cid-ohdyr4rw>
          <!-- Tender 1: System Integrator RFP -->
          <details class="tender" data-astro-cid-ohdyr4rw>
            <summary data-astro-cid-ohdyr4rw>
              <div data-astro-cid-ohdyr4rw>
                <p class="tender-title" data-astro-cid-ohdyr4rw>RFP for Selection of a System Integrator for Design, Development, Implementation and Operation of the Integrated Startup Platform for Asset, Resource &amp; Knowledge Exchange</p>
                <p class="tender-meta" data-astro-cid-ohdyr4rw>RFP · New Delhi · Issued by MC²+ (MC2 Foundation)</p>
              </div>
            ...
            <div class="tender-body" data-astro-cid-ohdyr4rw>
              <p class="prebid-badge" data-astro-cid-ohdyr4rw>
                ...
                Pre-Bid Meeting: 4:00 PM, 25 August 2026
              </p>
              <div class="actions d-flex flex-wrap align-items-center" data-astro-cid-ohdyr4rw>
                <a href="https://zfrmz.in/xPSRohUBq9q2fXMFqrxu" target="_blank" rel="noopener noreferrer"
                  data-astro-cid-b7tmfpbf="true" class="pill filled">
                  <span class="pill-label" data-astro-cid-b7tmfpbf>Submit Bid</span>
                ...
                <a href="<?php echo esc_url(get_template_directory_uri() . '/assets/procurements/MC2P-RFP-System-Integrator.pdf'); ?>" target="_blank" rel="noopener noreferrer"
                  aria-label="Download full RFP PDF for RFP for Selection of a System Integrator for Design, Development, Implementation and Operation of the Integrated Startup Platform for Asset, Resource &amp; Knowledge Exchange"
                  data-astro-cid-b7tmfpbf="true" class="pill ghost">
                  <span class="pill-label" data-astro-cid-b7tmfpbf>Download full RFP (PDF)</span>
                  <span class="pill-arrow" aria-hidden="true" data-astro-cid-b7tmfpbf>
                    <svg viewBox="0 0 44.9099 24.3499" fill="none" data-astro-cid-b7tmfpbf>
                      <path d="M0 12.1699L41.62 9.84009V14.51L0 12.1699Z" fill="currentColor" data-astro-cid-b7tmfpbf>
                      </path>
                ...
                <a href="<?php echo esc_url(get_template_directory_uri() . '/assets/procurements/MC2P-IT-SI-2026-27-001-Notice-01.pdf'); ?>" target="_blank" rel="noopener noreferrer"
                  aria-label="Download Pre-Bid Meeting Notice (PDF)" data-astro-cid-b7tmfpbf="true" class="pill ghost">
                  <span class="pill-label" data-astro-cid-b7tmfpbf>Download Pre-Bid Meeting Notice (PDF)</span>
                  <span class="pill-arrow" aria-hidden="true" data-astro-cid-b7tmfpbf>
                    <svg viewBox="0 0 44.9099 24.3499" fill="none" data-astro-cid-b7tmfpbf>
                      <path d="M0 12.1699L41.62 9.84009V14.51L0 12.1699Z" fill="currentColor" data-astro-cid-b7tmfpbf>
                      </path>
                ...
                <a href="<?php echo esc_url(get_template_directory_uri() . '/assets/procurements/MC2P-IT-SI-2026-27-001-Corrigendum-01.pdf'); ?>" target="_blank" rel="noopener noreferrer"
                  aria-label="Download Corrigendum (PDF)" data-astro-cid-b7tmfpbf="true" class="pill ghost">
                  <span class="pill-label" data-astro-cid-b7tmfpbf>CORRIGENDUM No. 1, dated 26.08.2026</span>
                  <span class="pill-arrow" aria-hidden="true" data-astro-cid-b7tmfpbf>
                    <svg viewBox="0 0 44.9099 24.3499" fill="none" data-astro-cid-b7tmfpbf>
                      <path d="M0 12.1699L41.62 9.84009V14.51L0 12.1699Z" fill="currentColor" data-astro-cid-b7tmfpbf>
                      </path>
